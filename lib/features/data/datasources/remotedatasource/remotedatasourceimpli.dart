...
import 'package:insta_cleanarchitecture/features/data/models/comment/commentmodel.dart';
import 'package:insta_cleanarchitecture/features/data/models/post/postmodel.dart';
import 'package:insta_cleanarchitecture/features/data/models/reply/replymodel.dart';
import 'package:insta_cleanarchitecture/features/data/models/user/usermodel.dart';
...
class FirebaseRemoteDataSourceImpli implements FirebaseRemoteDataSource {
...
// Retrieves a stream of post entities from Firestore, ordered by creation timestamp in descending order.
  ...
  Stream<List<PostEntity>> readPosts(PostEntity post) {
    final postCollection =
        firebaseFirestore.collection(FirebaseConst.posts).orderBy(
              "createAt",
              descending: true,
            );
